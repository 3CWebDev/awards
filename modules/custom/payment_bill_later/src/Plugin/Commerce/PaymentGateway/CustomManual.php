...
namespace Drupal\payment_bill_later\Plugin\Commerce\PaymentGateway;
...
/**
 * Provides the Custom Manual payment gateway.
 *
 * @CommercePaymentGateway(
 *   id = "custom_manual",
 *   label = "Custom Manual",
 *   display_label = "Custom Manual",
 *   modes = {
 *     "n/a" = @Translation("N/A"),
 *   },
 *   forms = {
 ...
 * )
 */
class CustomManual extends PaymentGatewayBase implements ManualPaymentGatewayInterface {
